import { predicateRace } from '../util/promises';
...
export abstract class ChainParser<P extends Parser<object>> implements Pick<Parser<P>, 'supports'> {
  ...
  /**
   * A simple node cache to increase the performance at parse() when getting the correct parser. You shouldn't use this
   * cache directly.
   */
