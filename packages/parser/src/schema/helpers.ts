...
/**
 * Creates a type formatter that removes the `#/definitions/` prefix from
 * `$ref` properties.
 *
 ...
 *
 * Which throws a reference error at runtime because the referenced def was going to be defined after
