...
/**
 * A KitaParser instance is a representation of a AST parser. It is used to read all source files
 * and parse them into an array of routes, schemas and providers.
 */
export interface KitaParser {
  ...
  /**
   * Parses all the given files, one by one, and yields the errors. If the array is empty,
   * the parsing was successful. You can get all routes, providers and schemas by calling
