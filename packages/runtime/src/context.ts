...
export type Route<OperationId extends string, Config extends RouteShorthandOptions = {}> = void;
 ...
 */
//@ts-expect-error - ignore unused
export type AsyncRoute<OperationId extends string, Config extends RouteShorthandOptions = {}> = void;
